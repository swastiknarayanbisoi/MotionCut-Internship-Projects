...
deleteAllPenTodos.addEventListener('click', ()=> {
    if(confirm("Are you sure want to delete all pending tasks ?")){
        ...
        localStorage.setItem("Pending Todos", JSON.stringify(listArr))
        showtask()
        showNotification("Successfully deleted all pending Tasks", "danger")
    }
})
...
function completeTask(index){
    ...
    showCompleteTask()
    showNotification("You have successfully Completed a Task", "success")
}
...
function comDeleteTask(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("Complete Todos", JSON.stringify(comArr))
        showCompleteTask()
        showNotification("Deleted one Task from Completed Tasks", "danger")
    }
}
...
deleteAllComTodos.addEventListener('click', ()=> {
    if(confirm("Are you sure want to delete all completed task?")){
        ...
        localStorage.setItem("Complete Todos", JSON.stringify(comArr))
        showCompleteTask()
        showNotification("Deleted All Task from Completed Tasks", "danger")
    }
})
